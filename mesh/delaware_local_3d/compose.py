...
def filt_WDBHU8(feat):              # filter HU-8 watersheds

    return feat["properties"]["Name"].lower() \
        == "middle delaware-musconetcong"


def filt_narivs(feat):              # filer enclosed streams

    return feat["properties"]["UP_CELLS"] > 10000
